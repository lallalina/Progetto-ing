...
export class LoginComponent implements OnInit {
  ...
  login(){
    this.ajax.login(this.form.mail, this.form.password).subscribe((response) => {   //viene eseguito solo dopo che il server risponde, response è l'oggetto che mi arriva dal server
